    ...
    <div class="swiper-wrapper">
        <div v-for="banner in bannerList" :key="banner.id" class="swiper-slide" style="background: #040B1B;">
            <a target="_blank" :href="banner.linkUrl">
                <img :src="banner.imageUrl" :alt="banner.title" style="width: 100%;height: 480px;">
            </a>
        </div>
    </div>
                    ...
                    <div class="cc-l-wrap">
                      <section class="course-img">
                        <img
                          ...
                          :alt="edu.title"
                          style="height: 330px; height: 190px;"
                        >
                        <div class="cc-mask">
                      ...
                      <h3 class="hLh30 txtOf mt10">
                        <a href="#" :title="edu.title" class="course-title fsize18 c-333">{{edu.title}}</a>
                      </h3>
                      <section class="mt10 hLh20 of">
                        ...
                        <span class="fl jgAttr c-ccc f-fA">
                          <i class="c-999 f-fA">{{edu.buyCount}}在学</i>
                          |
                          <i class="c-999 f-fA">{{edu.viewCount}}看过</i>
                        </span>
                      </section>
                    </div>
                  </li>
    ...
    export default {
      ...
      methods:{
        ...
        getHotCourseAndTeacher(){
          index.getIndexDatar().then(res=>{
            this.eduList = res.data.data.courseList
